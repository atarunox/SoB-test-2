export const gearList = [
  ...
  { id: "tinker_goggles", name: "Tinkerâ€™s Goggles", slot: "Head", effects: { Lore: 1, Cunning: 1 } },

  { id: "leather_vest", name: "Leather Vest", slot: "Torso", effects: { Willpower: 1 } },
  { id: "iron_chestplate", name: "Iron Chestplate", slot: "Torso", effects: { Defense: 2 } },
  ...
  { id: "iron_greaves", name: "Iron Greaves", slot: "Feet", effects: { Defense: 1 } },
